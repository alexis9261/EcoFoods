...
var Navbar = (function() {
	...
	function makeNavbarDark() {
		...
		document.getElementById("img_navbar_brand").src="assets/img/logo_a.png";
		document.getElementById("img_navbar_brand_cel").src="assets/img/logo_a.png";
		document.getElementById("img_navbar_brand_central").classList.remove('bg-nacbar-central1');
		document.getElementById("img_navbar_brand_central").classList.add('bg-nacbar-central2');
		document.getElementById("enlaceNavabarRed").classList.remove('text-white');
		document.getElementById("enlaceNavabarRed").classList.add('text-dark');
		document.getElementById("enlaceNavabarRed2").classList.remove('text-white');
		document.getElementById("enlaceNavabarRed2").classList.add('text-dark');
	}
	function makeNavbarLight() {
		$navbar.removeClass('navbar-dark').addClass('navbar-light');
		document.getElementById("img_navbar_brand").src="assets/img/logo_c.png";
		document.getElementById("img_navbar_brand_cel").src="assets/img/logo_c.png";
		document.getElementById("img_navbar_brand_central").classList.remove('bg-nacbar-central2');
		document.getElementById("img_navbar_brand_central").classList.add('bg-nacbar-central1');
		document.getElementById("enlaceNavabarRed").classList.remove('text-dark');
		document.getElementById("enlaceNavabarRed").classList.add('text-white');
		document.getElementById("enlaceNavabarRed2").classList.remove('text-dark');
		document.getElementById("enlaceNavabarRed2").classList.add('text-white');
	}
